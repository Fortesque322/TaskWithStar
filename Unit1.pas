...
//      for str in FDModel do
//      begin
//        Size := Length(str);
//        Move(data[Counter], FModel,sizeOf(Size));
//        inc(counter,SizeOf(Size));
//      end;

    Move(data[Counter],FModel,Size);    //Неправильно вписываю данные в массив
...
//      begin
//        Size := Length(str);
//        Move(data[Counter], FDetails[0],sizeOf(Size));
//        inc(counter,SizeOf(Size));
//      end;
    Move(data[Counter],FDetails,Size);
